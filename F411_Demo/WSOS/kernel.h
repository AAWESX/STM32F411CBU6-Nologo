...
//   WSOS重命名
#define WS_OS_Init_Task  InitTask   //初始化任务
#define WS_OS_On_Task    OnTask     //任务基本时钟
#define WS_OS_Run_Task   RunTask    //运行任务    

#define WS_OS_Create_Task   CreateTask
#define WS_OS_Create_Timer  CreateTimer


#define WS_OS_Start_Task   StartTask 		//开启任务
#define WS_OS_Stop_Task    StopTask			//暂停任务
#define WS_OS_Delete_Task  DeleteTask		//删除任务
