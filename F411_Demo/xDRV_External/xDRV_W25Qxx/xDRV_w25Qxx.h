#ifndef _xBSP_W25QXX_H_
#define _xBSP_W25QXX_H_
...
#endif
// 宏定义，设置 GPIO 引脚状态
#define W25QXX_CS(x)  ((x) ? HAL_GPIO_WritePin(W25QXX_CS_GPIO_Port, W25QXX_CS_Pin, GPIO_PIN_SET) : HAL_GPIO_WritePin(W25QXX_CS_GPIO_Port, W25QXX_CS_Pin, GPIO_PIN_RESET))
